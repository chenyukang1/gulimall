...
import com.cyk.gulimall.product.dao.SpuInfoDao;
import com.cyk.gulimall.product.entity.*;
import com.cyk.gulimall.product.feign.CouponFeignService;
import com.cyk.gulimall.product.feign.SearchFeignService;
import com.cyk.gulimall.product.feign.WareFeignService;
import com.cyk.gulimall.product.service.*;
import com.cyk.gulimall.product.vo.*;
            ...
            skus.forEach(item -> {
                ...
                if (skuReductionTo.getFullCount() > 0 || skuReductionTo.getFullPrice().compareTo(BigDecimal.ZERO) > 0) {
                    ...
                    if (r1.getCode() != 0) {
                        ...
                        // 回滚
                        throw new RuntimeException("远程保存sku积分信息失败");
                    }
                }
            });
        }
